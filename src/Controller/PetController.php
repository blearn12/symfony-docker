...
/**
 * Controller used to manage pet contents in the public part of the site.
 *
...
final class PetController extends AbstractController
{
     ...
     */
    #[Route('/', name: 'pet_index', defaults: ['page' => '1', '_format' => 'html'], methods: ['GET'])]
    #[Route('/rss.xml', name: 'pet_rss', defaults: ['page' => '1', '_format' => 'xml'], methods: ['GET'])]
    #[Route('/page/{page}', name: 'pet_index_paginated', defaults: ['_format' => 'html'], requirements: ['page' => Requirement::POSITIVE_INT], methods: ['GET'])]
    #[Cache(smaxage: 10)]
    public function index(Request $request, int $page, string $_format, PostRepository $posts, TagRepository $tags): Response
    {
        ...
        return $this->render('pet/index.'.$_format.'.twig', [
     ...
     */
    #[Route('/posts/{slug:post}', name: 'pet_post', requirements: ['slug' => Requirement::ASCII_SLUG], methods: ['GET'])]
    public function postShow(Post $post): Response
    {
        ...
        return $this->render('pet/post_show.html.twig', ['post' => $post]);
    }

    #[Route('/search', name: 'pet_search', methods: ['GET'])]
    public function search(Request $request): Response
    {
        return $this->render('pet/search.html.twig', ['query' => (string) $request->query->get('q', '')]);
    }
}
